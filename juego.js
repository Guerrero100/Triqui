...
const numMat = document.querySelector('#contriki')
const time1 = document.querySelector('#jugador1 .tiempo1')
const time2 = document.querySelector('#jugador2 .tiempo2')
...
const cliquear = document.querySelector('.contriki')
